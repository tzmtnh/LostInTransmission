...
////// Emissive:
                ...
                float3 emissive = pow((lerp(node_4646.rgb,saturate((1.0-(1.0-node_4646.rgb)*(1.0-node_7262.rgb))),_Blend)*(_LightSpeed*2.0+1.0)),(_LightSpeed*0.5+1.0));
