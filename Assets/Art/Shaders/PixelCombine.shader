...
////// Emissive:
                ...
                float3 emissive = (lerp(node_4646.rgb,saturate((1.0-(1.0-node_4646.rgb)*(1.0-node_7262.rgb))),_Blend)*(_LightSpeed*1.0+1.0));
