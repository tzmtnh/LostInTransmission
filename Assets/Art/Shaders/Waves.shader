...
////// Emissive:
                ...
                float delay = _Delay;
                float node_3953 = frac(((length(float2(i.uv0.r,((i.uv0.g*2.0+-1.0)*0.2)))-_DelayIntegral)*(delay*2.0+1.0)));
