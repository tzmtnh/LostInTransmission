...
////// Emissive:
                ...
                float4 node_154 = _Time;
                float2 node_4740 = float2(i.uv0.g,node_154.g);
                float2 node_5631_skew = node_4740 + 0.2127+node_4740.x*0.3713*node_4740.y;
                float2 node_5631_rnd = 4.789*sin(489.123*(node_5631_skew));
                float node_5631 = frac(node_5631_rnd.x*node_5631_rnd.y*(1+node_5631_skew.x));
                float node_3953 = frac((((length(float2(i.uv0.r,((i.uv0.g*2.0+-1.0)*0.2)))-_DelayIntegral)*2.0)+(node_5631*0.1)));
                float node_1232 = 4.0;
                float3 emissive = (_Gradient_var.rgb*(sin((i.uv0.r*node_5502))*sin((i.uv0.g*node_5502)))*floor((node_3953*node_3953) * node_1232) / (node_1232 - 1)*_Opasity);
