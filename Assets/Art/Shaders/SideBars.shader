    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float node_1982 = 0.0;
                float node_483 = 1.0;
                float node_8510 = lerp((node_8510_if_leA*node_1982)+(node_8510_if_leB*node_483),node_483,node_8510_if_leA*node_8510_if_leB);
                float node_2008_if_leA = step((1.0-node_7511),node_2424);
                float node_2008_if_leB = step(node_2424,(1.0-node_7511));
                float node_2008 = lerp((node_2008_if_leA*node_1982)+(node_2008_if_leB*node_483),node_483,node_2008_if_leA*node_2008_if_leB);
                float node_1378 = (node_8510*node_2008);
                clip((1.0-node_1378) - 0.5);
////// Lighting:
////// Emissive:
